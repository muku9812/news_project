...
class FrontendBaseController extends Controller
{
    public function index(){
        ...
        $data['slider']=News::where('status',1)->where('slider_key','1')->orderBy('id','desc')->take(7)->get();
        $data['latest']=News::where('status',1)->orderBy('id','desc')->take(2)->get();
        $data['latest3']=News::where('status',1)->orderBy('id','desc')->skip(2)->take(1)->get();

        $data['politics']=Category::where('name','राजनीति')->get();
        $category=Category::where('name','राजनीति')->pluck('id');
        $data['politics_news']=News::where('status','1')->where('category_id',$category)->orderBy('id','desc')->take(1)->get();
        $data['politics4']=News::where('status','1')->where('category_id',$category)->skip(1)->orderBy('id','desc')->take(4)->get();

        $data['politics8']= News::where('status','1')->where('category_id',$category)->skip(5)->orderBy('id','desc')->take(4)->get();
...
//        $data['row']= Setting::find(1);
        ...
        $data['news']->update();
        $data['latest']=News::where('status','1')->orderBy('id','desc')->where('slug','!=',$slug)->take(6)->get();
//        $data['category']=Category::all();
        $data['cate']=News::where('Category_id', $data['news']->CategoryId->id)->where('status','1')->where('slug','!=',$slug)->take(6)->orderBy('id','desc')->get();
        $data['view']=News::Where('status','1')->orderBy('view_count','desc')->take(6)->get();
//        $places=AddPlacement::where('name','Top')->where('status','1')->pluck('id');
//        $place=AddPlacement::where('name','Top Right')->where('status','1')->pluck('id');
...
//      dd($data);
        return view('frontend.details',compact('nepaliDate','data'));
    }
